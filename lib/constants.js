...
export const APP_FILES_SPACE_READY = 'APP_FILES_SPACE_READY';
...
export const GENERATOR_SPRITE_ERROR = 'GENERATOR_SPRITE_ERROR';
...
export const PARSER_THEMES_FOUND = 'PARSER_THEMES_FOUND';
