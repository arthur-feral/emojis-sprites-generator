 ...
 * @type {string}
 */
export const PARSER_SAVE_IMAGE_SUCCESS = 'PARSER_SAVE_IMAGE_SUCCESS';
export const PARSER_SAVE_IMAGE_ERROR = 'PARSER_SAVE_IMAGE_ERROR';

export const PARSER_FOUND_MODIFIERS = 'PARSER_FOUND_MODIFIERS';
export const PARSER_IMAGES_FOUND = 'PARSER_IMAGES_FOUND';
