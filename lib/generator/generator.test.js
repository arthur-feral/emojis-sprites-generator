...
const themeMap = _.reduce(emojisFullPeopleJSON.people.emojis, (result, emoji) => ({
  ...result,
  [emoji.name]: `${process.env.TEMP_FILES_PATH}/images/apple/${emoji.category}/${emoji.name}.png`,
}), {});
