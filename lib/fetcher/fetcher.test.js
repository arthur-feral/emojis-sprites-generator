...
import {
  APP_FILES_SPACE_READY, PARSER_PARSE_CATEGORIES_SUCCESS, PARSER_PARSE_CATEGORY_SUCCESS, PARSER_PARSE_EMOJI_SUCCESS,
} from '../constants';
  ...
  describe('Events', () => {
    ...
    describe('PARSER_PARSE_EMOJI_SUCCESS', () => {
      it('fetches all the themes images', async () => {
        const result = await emitter.emit(PARSER_PARSE_EMOJI_SUCCESS, emojiJSON1);
