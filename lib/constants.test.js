...
describe('Constants', () => {
  it('should contains these vars', () => {
    ...
    expect(constants.APP_FILES_SPACE_READY).to.equal('APP_FILES_SPACE_READY');
    ...
    expect(constants.PARSER_THEMES_FOUND).to.equal('PARSER_THEMES_FOUND');
    expect(constants.GENERATOR_SPRITE_ERROR).to.equal('GENERATOR_SPRITE_ERROR');
