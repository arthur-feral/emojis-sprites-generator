...
describe('Constants', () => {
  it('should contains these vars', () => {
    ...
    expect(constants.PARSER_SAVE_IMAGE_SUCCESS).to.equal('PARSER_SAVE_IMAGE_SUCCESS');
    expect(constants.PARSER_SAVE_IMAGE_ERROR).to.equal('PARSER_SAVE_IMAGE_ERROR');
